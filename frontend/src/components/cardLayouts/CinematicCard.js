  ...
  if (mode === 'filter') {
    return (
      <Box sx={{
        ...
        '&:hover': { boxShadow: '0 14px 40px rgba(0,0,0,0.7), 0 0 30px var(--accent-quiet)', transform: 'translateY(-2px)' }
      }} onClick={onClick}
      ...
      >
        ...
        <Box sx={{ position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column', p: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1, color: 'var(--dim)', fontSize: '0.75rem', mb: 0.5 }}>
          ...
          <Box sx={{ display: 'flex', gap: 0.5 }}>
            {[
              ...
              <Box key={p.l} onClick={(e) => { e.stopPropagation(); if (onProgressClick) onProgressClick(performer, p.type); }}
                ...
                <Typography sx={{ color: 'var(--text)', fontSize: '0.7rem', fontWeight: 'bold' }}>{p.l} {p.v}%</Typography>
              </Box>
            ))}
          </Box>
        </Box>
  ...
  return (
    ...
    >
      ...
      <Box onClick={handleRatingBadgeClick} sx={{
        ...
        bgcolor: 'rgba(0,0,0,0.6)', borderRadius: 4, px: 1.5, py: 0.5,
        color: 'var(--warn)', fontWeight: 'bold', fontSize: '0.85rem',
        border: '1px solid var(--warn-quiet)', cursor: 'pointer'
      ...
      <Box sx={{ position: 'absolute', bottom: 0, left: 0, right: 0, p: 2 }}>
        ...
        <Box sx={{ display: 'flex', gap: 1.5, color: 'var(--dim)', fontSize: '0.8rem' }}>
